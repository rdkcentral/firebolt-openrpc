...
export default class Transport {
  ...
  receiveHandler (message) {
    ...
    if (json.method) {
      ...
      throw "Invalid JSON-RPC message received from transport."
    }
  }
  ...
  init () {
    ...
    if (this._implementation == null) {
      this._implementation = this.constructTransportLayer()
    }
  }
}
win.__firebolt = win.__firebolt || {}
