...
export default class Transport {
  ...
  static listen(module, method, params, options) {
    return Transport.get()._sendAndGetId(module, method, params, options)
  }
  ...
  _send (module, method, params, options) {
    if (Array.isArray(module) && !method && !params) {
      ...
      return this._sendAndGetId(module, method, params, options).promise
    }
  }

  _sendAndGetId (module, method, params, options) {
